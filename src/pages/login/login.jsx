    ...
    return (
      <Animate transitionName="fade">
        <div className="login-container">
              ...
              <section className="input-container">
                ...
                <div
                  className={`button-switch ${
                    this.state.showPwd ? "change-to-text" : ""
                  }`}
                >
                  <div
                    className={`circle-button ${
                      this.state.showPwd ? "trans_to_right" : ""
                    }`}
              ...
              <section className="input-container captcha-code-container">
                ...
                <div className="img-change-img">
                  ...
                  <div
                    ...
                    onClick={this.getCaptchaCode.bind(this)}
                  >
                    <p>看不清</p>
                    <p>换一张</p>
                  </div>
          ...
          <Link to="/forget" className="to-forget">
            重置密码?
          </Link>
          {this.state.hasAlert && (
            <AlertTip
