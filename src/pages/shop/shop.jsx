...
class Shop extends Component {
  ...
  calculateMoney = () => {
    ...
    this.setState({
      totalPrice,
      miniMoney:
        this.state.shopDetailData.float_minimum_order_amount - totalPrice
    });
  };
  // 清空购物车
  clearCart = () => {
      ...
      <div className="shop-container">
        ...
        <header className="shop-detail-header">
          ...
          <div className="description-header">
            ...
            this.state.shopDetailData.activities.length ? (
            ...
            <div className="food-container">
              <div className="menu-container">
                  ...
                  <ul>
                    {this.state.menuList.map((item, index) => {
                      return (
                        ...
                        >
                          <img
                            src={item.icon_url ? getImgPath(item.icon_url) : ""}
                            alt=""
                          />
                          <span>{item.name}</span>
                ...
                <div className="menu-right">
                  <ul>
                    {this.state.menuList
                      .slice(this.state.activeIndex, this.state.activeIndex + 1)
                      .map((item, index) => {
                        return (
                          <li key={index}>
                            <header className="menu-detail-header">
                              <div className="menu-detail-header-left">
                                <strong className="menu-item-title">
                                  {item.name}
                                </strong>
                              ...
                              <span className="menu-detail-header-right" />
                            </header>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <div className="menu-food-description">
                                      <h3 className="food-description-head">
                                        <strong className="description-foodname">
                                          {food.name}
                                        </strong>
                                      ...
                                      <p className="food-description-content">
                                        {food.description}
                                      </p>
                                  ...
                                  <footer className="menu-detail-footer">
                                    ...
                                    <div className="add-del-icon">
                                      <div
                                        className="icon-wuuiconsuoxiao"
                                        onClick={this.handleAddFoodCount.bind(
                                          this,
                                          food.num,
                                          -1
                                        )}
                                      />
                                      <div>
                                        {this.state.foodList[food.num].qty}
                                      </div>
                                      <div
                                        className="icon-wuuiconxiangjifangda"
                                        onClick={this.handleAddFoodCount.bind(
                                          this,
                                          food.num,
                                          1
              ...
              <div className="buy-cart-container">
                <div className="cart-icon-num">
                  ...
                  >
                    ...
                    <div className="icon-ziyuan" />
                  </div>
                  <div className="cart-num">
                    <div>¥{this.state.totalPrice}</div>
                    <div>
                      配送费¥{this.state.shopDetailData.float_delivery_fee}
                    </div>
                  </div>
                </div>
                <div
                  ...
                  className={
                    this.state.miniMoney > 0
                      ? "gotopay"
                      : "gotopay gotopay-active"
                  }
                >
                  {this.state.miniMoney > 0 ? (
                    <div className="gotopay-button-style">
